...
import { calgary } from "../../../utils/fonts";
        ...
        <div className="mx-auto max-w-2xl py-32">
          <FadeIn>
            <div className="text-center">
              <h1 className="text-7xl kimchi tracking-tight pt-12 text-white sm:text-9xl">
                Climate Change :<br />
                At Scale
              </h1>
              <p className="mt-6 text-lg leading-8 text-white">
                Revolutionizing Commercial Manufacturing: Achieving Scalable and
                Economical Impact
              </p>
